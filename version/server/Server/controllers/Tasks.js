...
module.exports.getTask = function getTask (req, res, next) {
  ...
  Tasks.getTask(req.params.taskId, req.user) 
    .then(function (response) {
...
module.exports.updateTask = function updateTask (req, res, next) {
  Tasks.updateTask(req.body, req.params.taskId, req.user) 
    .then(function (response) {
      utils.writeJson(res, response, 204);
    })
    .catch(function (response) {
...
module.exports.completeTask = function completeTask (req, res, next) {
  Tasks.completeTask(req.params.taskId, req.user)
    ...
    .catch(function (response) {
      if(response == 403){
        utils.writeJson(res, { errors: [{ 'param': 'Server', 'msg': 'The user is not the owner or an assigne of the task' }], }, 403);
      }
      else if (response == 404){
          utils.writeJson(res, { errors: [{ 'param': 'Server', 'msg': 'The task does not exist.' }], }, 404);
      }
